...
async function checkNickname(gameCode, userId, zoneId) {
  ...
  if (apiId && apiKey) {
    try {
      ...
      // Hanya kirim zone_id jika tidak kosong (beberapa game tidak butuh zone_id)
      if (zoneId && zoneId.trim() !== '') {
        form.append('zone_id', zoneId.trim());
      }
      ...
      // VIP Reseller menggunakan field "result" (bukan "status")
