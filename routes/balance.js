...
const TOKOPAY_METHODS = {
  QRISREALTIME:    { label: '⚡ QRIS' },
  qris:            { label: '⚡ QRIS' },
  dana:            { label: '💙 DANA' },
  ovo:             { label: '💜 OVO' },
  gopay:           { label: '💚 GoPay' },
  shopeepay:       { label: '🟠 ShopeePay' },
  bca_va:          { label: '🏦 Virtual Account BCA' },
  bni_va:          { label: '🏦 Virtual Account BNI' },
  bri_va:          { label: '🏦 Virtual Account BRI' },
  mandiri_va:      { label: '🏦 Virtual Account Mandiri' },
};
