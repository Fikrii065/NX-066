...
async function autoMigrate() {
  ...
  try {
    ...
    // Migrate: icon_url dan banner_url ke MEDIUMTEXT jika masih TEXT
    try {
      await conn.query('ALTER TABLE games MODIFY COLUMN icon_url MEDIUMTEXT NULL');
      await conn.query('ALTER TABLE games MODIFY COLUMN banner_url MEDIUMTEXT NULL');
    } catch(_) {}
