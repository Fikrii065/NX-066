...
INSERT IGNORE INTO categories (name, slug, icon, sort_order, is_active) VALUES
  ('Mobile Game',    'mobile-game',    '📱', 1, 1),
  ('PC Game',        'pc-game',        '🖥️',  2, 1),
  ('Voucher',        'voucher',        '🎟️',  3, 1),
  ('Streaming',      'streaming',      '📺', 4, 1),
  ('Lainnya',        'lainnya',        '📦', 99, 1);
