...
router.post('/create', async (req, res) => {
  ...
  try {
    ...
    const [settingsRows] = await conn.query(
      "SELECT key_name, value FROM settings WHERE key_name IN ('markup_percent','markup_minimum','tokopay_merchant_id','tokopay_secret_key') OR key_name LIKE 'fee_%'"
    );
    ...
    await conn.query(
      'UPDATE orders SET payment_url=?, va_number=?, expired_at=? WHERE order_id=?',
      [paymentResult.payment_url, paymentResult.va_number, paymentResult.expired_at, orderId]
    );
  ...
  try {
    const [rows] = await db.query(
      `SELECT o.order_id, o.created_at, o.customer_no, o.customer_name, o.total_amount,
              ...
              o.expired_at, o.paid_at, o.completed_at, o.sn,
