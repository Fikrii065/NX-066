...
async function migrate() {
  ...
  const queries = [
    ...
    // ALTER existing columns ke MEDIUMTEXT (untuk DB yang sudah ada)
    `ALTER TABLE games MODIFY COLUMN icon_url MEDIUMTEXT NULL`,
    `ALTER TABLE games MODIFY COLUMN banner_url MEDIUMTEXT NULL`,
    `ALTER TABLE banners MODIFY COLUMN image_url MEDIUMTEXT NOT NULL`,
